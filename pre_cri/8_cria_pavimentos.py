...
with open('./pre_cri/localizacao_vagas.txt', 'w', encoding='utf-8') as f:
    f.write(texto_vagas)

with open('./pre_cri/localizacao_apartamentos.txt', 'w', encoding='utf-8') as f:
    f.write(texto_apartamentos)
    
with open('./pre_cri/localizacao_lojas.txt', 'w', encoding='utf-8') as f:
    f.write(texto_lojas)
